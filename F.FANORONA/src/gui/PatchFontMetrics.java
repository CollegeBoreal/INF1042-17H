...
/**
 * **************************************************************************
 * PatchFontMetrics wraps around a FontMetrics to correct some glaring errors
 * that screw up pages laid out using FontMetrics!
 * 
 * The main problems I've encountered were with heights. Except for the
 * maxAdvance (which I dont understand what it's for), the other parameters have
 * appeared to be reasonable.
 * 
 * I've patched up the heights more or less heuristically; the big danger is
 * that on some platform without such a correlation between pixels & points this
 * may be worse than the original problem!
 * 
...
public class PatchFontMetrics extends FontMetrics {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8436905132916492022L;
	FontMetrics fm;
